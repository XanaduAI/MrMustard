...
class TestPolyExpAnsatzOld:
    ...
    def test_add(self):
        ...
        ansatz = PolyExpAnsatzOld(A1, b1, c1)
        ansatz2 = PolyExpAnsatzOld(A2, b2, c2)
    ...
    def test_eq(self):
        ...
        ansatz = PolyExpAnsatzOld(A, b, c)
        ansatz2 = PolyExpAnsatzOld(2 * A, 2 * b, 2 * c)
