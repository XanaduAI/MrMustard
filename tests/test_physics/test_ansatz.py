...
class TestDiffOpPolyExpAnsatz:
    ...
    def test_call_none(self):
        ...
        obj1_none0 = DiffOpPolyExpAnsatz(obj1_none.A[0],obj1_none.b[0],obj1_none.c[0].reshape(1,5,5,5))
        obj1_none1 = DiffOpPolyExpAnsatz(obj1_none.A[1],obj1_none.b[1],obj1_none.c[1].reshape(1,5,5,5))
        val1 = obj1(z1)
        val2 = np.array((obj1_none0(z2[0].reshape(1,-1)),obj1_none1(z2[1].reshape(1,-1)))).reshape(-1)
        assert np.allclose(val1,val2)
