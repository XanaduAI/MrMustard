...
def test_join_Abc_real():
    ...
    A1, b1, c1 = triples_utils.vacuum_state_Abc(2)
    A2, b2, c2 = triples_utils.displacement_gate_Abc(x=[0.1, 0.2], y=0.3)
    idx1 = [0, 1]
    idx2 = [0, 1]
...
def test_complex_gaussian_integral_2_not_batched():
    ...
    A1, b1, c1 = triples_utils.vacuum_state_Abc(2)
    A2, b2, c2 = triples_utils.displacement_gate_Abc(x=[0.1, 0.2], y=0.3)
    A3, b3, c3 = triples_utils.displaced_squeezed_vacuum_state_Abc(x=[0.1, 0.2], y=0.3)
...
def test_complex_gaussian_integral_2_batched():
    ...
    A1, b1, c1 = triples_utils.vacuum_state_Abc(1)
    A2a, b2a, c2a = triples_utils.squeezing_gate_Abc(r=0.1, delta=0.3)
    A2b, b2b, c2b = triples_utils.squeezing_gate_Abc(r=0.2, delta=0.4)
    A2c, b2c, c2c = triples_utils.squeezing_gate_Abc(r=0.3, delta=0.5)
    A3a, b3a, c3a = triples_utils.squeezed_vacuum_state_Abc(r=0.1, phi=0.3)
    A3b, b3b, c3b = triples_utils.squeezed_vacuum_state_Abc(r=0.2, phi=0.4)
    A3c, b3c, c3c = triples_utils.squeezed_vacuum_state_Abc(r=0.3, phi=0.5)
...
def test_complex_gaussian_integral_1_not_batched():
    ...
    A, b, c = triples_utils.thermal_state_Abc(nbar=[0.5, 0.9, 1.0])
    Ar, br, cr = triples_utils.vacuum_state_Abc(0)
