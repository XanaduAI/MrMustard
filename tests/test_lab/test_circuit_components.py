...
class TestCircuitComponent:
    ...
    def test_dual(self):
        ...
        assert d1_dual.name == d1.name + "_dual"
    ...
    def test_fock_component_no_bargmann(self):
        ...
        with pytest.raises(AttributeError, match=r"No Bargmann data for this component."):
            CC.bargmann_triple()
    ...
    def test_from_fock(self):
        ...
        assert cc.ansatz == ArrayAnsatz(array=array, batch_dims=0)
        assert cc.wires == Wires(
            modes_out_bra={}, modes_in_bra={}, modes_out_ket={0}, modes_in_ket={}
        )

        with pytest.raises(
            ValueError, match=r"Wires expect 2 core dimensions, got 1 in the given array."
        ):
            CircuitComponent.from_fock(
                array=array,
                batch_dims=0,
                modes_out_bra={},
                modes_in_bra={},
