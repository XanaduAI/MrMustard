...
from mrmustard.training.parameter import Constant, Unitary, Euclidean, Symplectic, Trainable
...
@pytest.mark.parametrize("trainable_class", (Euclidean, Unitary, Symplectic))
