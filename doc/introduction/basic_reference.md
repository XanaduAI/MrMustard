...
### Optimization
The `Optimizer` (available in `mrmustard.training` uses Adam underneath the hood for Euclidean parameters and a custom symplectic optimizer for Gaussian gates and states and an unitary/orthogonal optimizer for interferometers.
