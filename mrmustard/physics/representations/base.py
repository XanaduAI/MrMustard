...
class RepresentationBase(ABC):
    ...
    @property
    @abstractmethod
    def conj(self) -> RepresentationBase:
        r"""
    ...
    @classmethod
    @abstractmethod
    def from_dict(cls, data: dict[str, ArrayLike]) -> RepresentationBase:
        r"""
    ...
    @classmethod
    @abstractmethod
    def from_function(cls, fn: Callable, **kwargs: Any) -> RepresentationBase:
        r"""
        Returns a representation from a function and kwargs.
        """

    @abstractmethod
    def reorder(self, order: tuple[int, ...] | list[int]) -> RepresentationBase:
        r"""
    ...
    @abstractmethod
    def trace(self, idxs1: tuple[int, ...], idxs2: tuple[int, ...]) -> RepresentationBase:
        r"""
    ...
    @abstractmethod
    def __add__(self, other: RepresentationBase) -> RepresentationBase:
        r"""
    ...
    @abstractmethod
    def __and__(self, other: RepresentationBase) -> RepresentationBase:
        r"""
    ...
    @abstractmethod
    def __call__(self, z: Batch[Vector]) -> Scalar | RepresentationBase:
        r"""
    ...
    @abstractmethod
    def __getitem__(self, idx: int | tuple[int, ...]) -> RepresentationBase:
        r"""
        Returns a copy of self with the given indices marked for contraction.
        """

    @abstractmethod
    def __matmul__(self, other: RepresentationBase) -> RepresentationBase:
        r"""
    ...
    @abstractmethod
    def __mul__(self, other: Scalar | RepresentationBase) -> RepresentationBase:
        r"""
    ...
    @abstractmethod
    def __neg__(self) -> RepresentationBase:
        r"""
        Negates the values in the representation.
        """

    def __rmul__(self, other: RepresentationBase | Scalar) -> RepresentationBase:
        r"""
        Multiplies this representation by another or by a scalar on the right.
        """
        return self.__mul__(other)

    def __sub__(self, other: RepresentationBase) -> RepresentationBase:
        r"""
    ...
    @abstractmethod
    def __truediv__(self, other: Scalar | RepresentationBase) -> RepresentationBase:
        r"""
