...
from mrmustard.mathlib.lattice.strategies.compactFock.diagonal_amps import (
    fock_representation_diagonal_amps,
)
from mrmustard.mathlib.lattice.strategies.compactFock.diagonal_grad import (
    fock_representation_diagonal_grad,
)
from mrmustard.mathlib.lattice.strategies.compactFock.singleLeftoverMode_amps import (
    fock_representation_1leftoverMode_amps,
)
from mrmustard.mathlib.lattice.strategies.compactFock.singleLeftoverMode_grad import (
