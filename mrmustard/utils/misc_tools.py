...
def duck_type_checker(obj_a:object, obj_b:object) -> bool:
    ...
    Note also that this checks for the exact match between types -via attributes-, this system will
    likely not work with subclasses since there is a high probability that they might have 
