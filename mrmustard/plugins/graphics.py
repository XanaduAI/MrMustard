...
def wigner(state, hbar: float = mm.hbar, filename: str = "", xbounds=(-6, 6), ybounds=(-6, 6)):
    r"""
...
def mikkel_plot(dm: np.ndarray, filename: str = "", xbounds=(-6, 6), ybounds=(-6, 6), hbar=mm.hbar):
    rho = dm.numpy()
    sf.hbar = hbar
