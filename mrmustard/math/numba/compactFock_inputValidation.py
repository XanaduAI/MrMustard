...
from mrmustard.math.compactFockAmplitudes_1leftoverMode_amps import fock_representation_1leftoverMode_amps
from mrmustard.math.compactFockAmplitudes_1leftoverMode_grad import fock_representation_1leftoverMode_grad
