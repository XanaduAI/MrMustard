...
import numpy as np
from mrmustard.math.lattice.strategies.compactFock.python.compactFock_diagonal_amps import fock_representation_diagonal_amps
from mrmustard.math.lattice.strategies.compactFock.python.compactFock_diagonal_grad import fock_representation_diagonal_grad
from mrmustard.math.lattice.strategies.compactFock.python.compactFock_1leftoverMode_amps import (
    fock_representation_1leftoverMode_amps,
)
from mrmustard.math.lattice.strategies.compactFock.python.compactFock_1leftoverMode_grad import (
