...
import numpy as np
from mrmustard.math.compactFock.diagonal_amps import fock_representation_diagonal_amps
from mrmustard.math.compactFock.diagonal_grad import fock_representation_diagonal_grad
from mrmustard.math.compactFock.singleLeftoverMode_amps import (
    fock_representation_1leftoverMode_amps,
)
from mrmustard.math.compactFock.singleLeftoverMode_grad import (
