...
@njit
def fock_representation_compact_NUMBA(A, B, G0, M, cutoff, PARTITIONS, BINOM, shape0, shape2, shape11, shape1, shape0_tuple):
    '''
...
def fock_representation_compact(A, B, G0, M, cutoff):
    ...
    return fock_representation_compact_NUMBA(A, B, G0, M, cutoff, PARTITIONS, BINOM, shape0, shape2, shape11, shape1,
                                             shape0_tuple)
