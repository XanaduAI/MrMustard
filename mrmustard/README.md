...
The math module contains the concrete implementations of the math interface. At the moment we have [Numpy](https://github.com/XanaduAI/MrMustard/blob/main/mrmustard/math/backend_numpy.py) and [jax](https://github.com/XanaduAI/MrMustard/blob/main/mrmustard/math/backend_jax.py).
